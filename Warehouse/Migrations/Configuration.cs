namespace Warehouse.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Warehouse.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(Warehouse.Models.ApplicationDbContext context)
        {
            ...
            //    new LaptopModels { Name = "Notebook HP 250 G7", Description = "6MR38ES", Quantity = 88, Manufacturer = "HP", OS = "Windows 10", Price = 4443, OldPrice = 5552, Date = DateTime.Now },
            ...
            //    new LaptopModels { Name = "Notebook HP 255 G7",Description= "UMA 15.6 FHD/R5-3500U/8GB/256GB/W10Home, 2D231EA",Quantity=18,Manufacturer="HP",OS= "Windows 10 Home",Price= 4776,FullPrice=4996, Date = DateTime.Now},
            ...
            //    new LaptopModels { Name = "Notebook HP Pavilion x360",Description= "14-dw0012nm, 3M710EA",Quantity=33,Manufacturer="HP",OS= "Windows 10 Home",Price= 5887,OldPrice=5997, Date = DateTime.Now},
            ...
            //    new LaptopModels { Name = "Notebook Acer Aspire 5",Description= "NX.HFNEX.002",Quantity=63,Manufacturer="Acer",OS= "Boot-up Linux",Price= 4443,FullPrice=4533, Date = DateTime.Now},
            ...
            //    new StoreModels{ Name = "SD Store Outlet Sveta Nedelja",Location="Sveta Nedelja",ZipCode=10431,Address="Dr.Franje Tuđmana 69",QoP=280,StockPrice=500000,Telephone="010101012",Email="sveta.nedelja@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now},
            //    new StoreModels{ Name = "SD Megastore Westgate",Location="Jablanovec",ZipCode=10290,Address="Zaprešička 2",QoP=144,StockPrice=500000,Telephone="00000000",Email="westgate@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now},
            //    new StoreModels{ Name = "SD Megastore Arena Park",Location="Zagreb",ZipCode=10000,Address="Jaruščica 4",QoP=400,StockPrice=500000,Telephone="03030303",Email="arena@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now},
            //    new StoreModels{ Name = "Samsung Experience Store Arena",Location="Ulica Vice Vukova 6",ZipCode=10000,Address="Zagreb",QoP=221,StockPrice=500000,Telephone="04040404",Email="samsungarena@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now},
            //    new StoreModels{ Name = "PlayStation Experience Stand Arena",Location="Zagreb",ZipCode=10000,Address="Ulica Vice Vukova 6",QoP=500,StockPrice=50000,Telephone="05050505",Email="sonyarena@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now},
            //    new StoreModels{ Name = "SD Store Supernova Dubrava (ex-Garden Mall)",Location="Zagreb",ZipCode=10000,Address="Ulica Rudolfa Kolaka 14",QoP=600,StockPrice=500000,Telephone="06060606",Email="gardenmall@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now},
            //    new StoreModels{ Name = "SD Superstore CCO East",Location="Zagreb",ZipCode=10000,Address="Slavonska avenija 11d",QoP=202,StockPrice=50000,Telephone="06060606",Email="ccoe@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now},
            //    new StoreModels{ Name = "SD Store CCO West",Location="Zagreb",ZipCode=10000,Address="Jankomir 33",QoP=338,StockPrice=500000,Telephone="07070707",Email="ccow@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now},
            //    new StoreModels{ Name = "SD Superstore CCO Split",Location="Split",ZipCode=21000,Address="Vukovarska 207",QoP=120,StockPrice=50000,Telephone="08080808",Email="split@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now},
            //    new StoreModels{ Name = "SD Megastore Joker",Location="Split",ZipCode=21000,Address="Put Brodarice 6",QoP=164,StockPrice=500000,Telephone="09090909",Email="splitjoker@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now},
            //    new StoreModels{ Name= "Samsung Experience Store Split",Location="Split",ZipCode=21000,Address="Vukovarska 207",QoP=444,StockPrice=500000,Telephone="10101010",Email="samsungsplit@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now},
            //    new StoreModels{ Name= "SD Store Rijeka",Location="Rijeka",ZipCode=51000,Address="Užarska 30",QoP=454,StockPrice=500000,Telephone="1111111",Email="rijeka@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now},
            //    new StoreModels{ Name= "SD Megastore Rijeka Marti",Location="Rijeka",ZipCode=51000,Address="Martinkovac 127",QoP=238,StockPrice=50000,Telephone="45454545",Email="rijekamarti@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now},
            //    new StoreModels{ Name= "SD Store Zadar",Location="Zadar",ZipCode=23000,QoP=499,StockPrice=50000,Telephone="45454512",Email="zadar@sancta-domenica.hr",WorkingTime="08-18h ponedjeljak-petak, Subota i nedjelja - ne radi", Date = DateTime.Now}
            //};
