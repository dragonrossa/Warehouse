namespace Warehouse.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Warehouse.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(Warehouse.Models.ApplicationDbContext context)
        {
            ...
            //{
            //    new SupplierModels{ SupplierName = "Chipoteka", Location = "Zagreb", Date = DateTime.Now},
            //    new SupplierModels{ SupplierName = "Instar Informatika", Location = "Zagreb", Date = DateTime.Now},
            //    new SupplierModels{ SupplierName = "HG Spot", Location = "Zagreb", Date = DateTime.Now},
            //    new SupplierModels{ SupplierName = "Mikronis", Location = "Zagreb", Date = DateTime.Now},
            //    new SupplierModels{ SupplierName = "Ronis", Location = "Zagreb",Date = DateTime.Now},
            //    new SupplierModels{ SupplierName = "Links", Location = "Zagreb", Date = DateTime.Now},
            //    new SupplierModels{ SupplierName = "Vacom", Location = "Zagreb", Date = DateTime.Now},
            //};
